...
public class PlayfabLoginRegisterController : MonoBehaviour
{
    ...
    [SerializeField]
    private TMP_InputField _email_register;

    [SerializeField]
    private TMP_InputField _pass1_register;

    [SerializeField]
    private TMP_InputField _pass2_register;
    ...
    [SerializeField]
    private TMP_InputField _email_login;

    [SerializeField]
    private TMP_InputField _pass1_login;
    ...
    {
        if (result.InfoResultPayload.PlayerProfile == null || result.InfoResultPayload.PlayerProfile.DisplayName == null || result.InfoResultPayload.PlayerProfile.DisplayName.Length < 3)
        {
            ShowDisplayName();
        }
        else
